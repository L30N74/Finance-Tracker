            ...
            MaterialButton(
              ...
              onPressed: () {
                setState(() {
                  List<Manager> data = [
                    MyHomePage.manager,
                    new Manager(1000, 200, 900, "12/2020"),
                    new Manager(1000, 200, 900, "1/2021"),
                    new Manager(500, 400, 100, "2/2021"),
                  ];
                  Navigator.push(context, MaterialPageRoute(builder: (context) => GraphView(data: data)));
